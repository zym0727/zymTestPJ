        ...
        <div class="container">
            ...
            <div class="form-group">
                <div class="row" id="findBar">
                    <div class="font">
                        <label class="myLabel" style="text-align: center; margin-top:8px" >班级编号：</label>
                    </div>
                    <div class="col-sm-2">
                    ...
                    <div class="font">
                        <label class="myLabel"
                               style="text-align: center; margin-top:8px; margin-left: 20px">班级名字：</label>
                    </div>
                    <div class="col-sm-2">
                    ...
                    <div class="font">
                        <label class="myLabel" style="text-align: center;
                         margin-top:8px;margin-left: 20px">入学时间/年级：</label>
                    </div>
                    <div class="col-sm-3">
            ...
            <div id="toolbar">
                <button id="addClass" class="btn btn-primary" type="button">增加一个班级</button>
                <button id="batchAddClass" class="btn btn-info" type="button">
                    批量上传
                </button>
                <input name="uploadFile" type="file" id="classFile" style="display: none"/>
                <button id="batchDeleteClass" class="btn btn-danger" type="button">
                    批量删除
                </button>
            </div>

            <table id="classTable" class="table table-striped"></table>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myUpdateModalLabel"
                                style="margin-left:160px">修改班级信息</h4>
                        </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myAddModalLabel"
                                style="margin-left:160px">添加一个班级</h4>
                        </div>
                        <div class="modal-body">
                            <form>
                                <div class="form-group">
